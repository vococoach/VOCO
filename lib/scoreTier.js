...
//
// `accent` is used for graphics (disc, border, tint) always, and for small
// text on a dark results card (a night/midday CelebrationCard — see
// lib/timeTheme.js). `deep` is a darker shade of the same hue for small text
// on a light DAWN results card specifically, where the accent itself is too
// pale to read (each `deep` clears 4.5:1 against the DAWN card color,
// #FFF9F2). components/CelebrationCard.js picks between them by theme.
