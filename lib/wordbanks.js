...
//   gre-vocab             (lib/greVocabulary.js) categories organized by
//                        CONNOTATION (Positive Charge, Negative Charge,
//                        Neutral & Academic) instead of theme or function —
//                        recognizing a word's charge is a real GRE technique.
//                        Difficulty is calibrated above the other courses;
//                        every sentence is set in an academic/scholarly voice.
//
...
import { greVocabularyCategories } from "./greVocabulary";
...
export const courses = [
  ...
  },
  {
    ...
    title: "GRE Vocab",
    description:
      "Graduate-level vocabulary for the GRE, organized by connotation — a word's positive or negative charge, the technique test-takers rely on even before they know its precise definition.",
    categories: greVocabularyCategories,
  },
];
