...
//
// Quiz format, in both courses: a sentence with a blank, four plausible answer
...
// The SAT Vocab course's categories — unchanged from before courses existed.
const satVocabCategories = [
  {
